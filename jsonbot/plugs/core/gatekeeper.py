# jsonbot/plugs/core/gatekeeper.py
#
#
...
examples.add(
    "gatekeeper-allow",
    "add JID of remote bot that we allow to receice events from",
    "gatekeeper-allow jsonbot@jsonbot.org",
)
...
examples.add(
    "gatekeeper-deny",
    "remove JID of remote bot",
    "gatekeeper-deny evilfscker@pissof.com",
)
