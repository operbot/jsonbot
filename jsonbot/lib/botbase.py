...
from jsonbot.lib.threads import threaded
...
from jsonbot.utils.url import decode_html_entities
...
try:
    ...
    from jsonbot.imports import gettornado
...
class BotBase(LazyDict):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.reconnectcount = 0
        self.cfg.nick = nick or self.cfg.nick or "jsonbot"
        try:
