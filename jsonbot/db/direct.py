...
from jsonbot.utils.generic import tolatin1
        ...
        if self.dbtype == "mysql":
            ...
            try:
                ...
                self.connection = sqlite3.connect(
                    self.datadir + os.sep + self.dbname, check_same_thread=False
                )
            except ImportError:
                import sqlite
        ...
        if self.dbtype == "mysql":
            try:
                ...
                try:
                    ...
                    logging.error("failed reconnect: %s" % str(ex))
                    return
