    ...
    1) setup
        ...
        * test with:
        ...
        ::
            ...
            echo "YOOO" | ./bin/jsonbot-udp -p <nick>

        * you can run !udp-cfgsave and edit ~/.jsonbot/config/jsonbot.plugs.socket.udp/config if need be.
...
from jsonbot.utils.generic import strippedtxt
