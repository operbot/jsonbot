# jsonbot/plugs/common/wikipedia.py
#
#
...
from jsonbot.utils.generic import fromenc, handle_exception, splittxt
from jsonbot.utils.rsslist import rsslist
...
def handle_wikipedia(bot, ievent):
    ...
    if result:
        if bot.type == "sxmpp" and not ievent.groupchat:
            showall = True
...
examples.add(
    "wikipedia", "search wikipedia for <what>", "1) wikipedia bot 2) wikipedia -nl bot"
)
