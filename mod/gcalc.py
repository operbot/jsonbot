...
from jsonbot.utils.url import useragent
...
def handle_gcalc(bot, ievent):
    ...
    req = urllib.request.Request(
        "http://www.google.com/ig/calculator?hl=en&q=%s" % expr,
        None,
    ...
    try:
        ...
        if rhs and lhs:
            ...
            ievent.reply("hmmm can't get a result ..")
...
examples.add(
    "gcalc", "calculate an expression using the google calculator", "gcalc 1 + 1"
)
